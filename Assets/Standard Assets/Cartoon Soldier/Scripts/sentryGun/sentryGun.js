...
//
private var turretAudioGeneratorScript : turretAudioGenerator;
//
...
//
private var turretAudioGenerator : Transform;
//
...
function Start(){
	...
	//
	turretAudioGenerator = barrel.Find("turretAudioGenerator");
	//
	...
	//
	turretAudioGeneratorScript = turretAudioGenerator.GetComponent("turretAudioGenerator");
	//
...
function Update (){
	...
	if(barrelSpeed > maxBarrelSpeed * 0.8){
		...
		//
		turretAudioGeneratorScript.on = firing;
		//
	}
	else{
		...
		//
		turretAudioGeneratorScript.on = false;
		//
	}
